...
bre2 = int(input("Enter Breadth:"))
rec2 = Rectangle(len2,bre2)

len3 = int(input("Enter length:"))
bre3 = int(input("Enter Breadth:"))
rec3 = Rectangle(len3,bre3)

len4 = int(input("Enter length:"))
bre4 = int(input("Enter Breadth:"))
rec4 = Rectangle(len4,bre4)

len5 = int(input("Enter length:"))
bre5 = int(input("Enter Breadth:"))
